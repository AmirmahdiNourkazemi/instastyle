...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  ProductBloc(this.productUseCase , this.paymentUsecase , this.myketPaymentUsecase)
      : super(ProductState(
    ...
    on<ProductPaymentEvent>(
      (event, emit) async {
        ...
        DataState dataState = await myketPaymentUsecase.call((MyketPayment(event.productID, event.productUuid)));
        print(dataState);
        if (dataState is DataSuccess) {
          emit(state.copyWith(
